...
const TN={
MEX:{fr:"Mexique",en:"Mexico",ar:"المكسيك",pt:"México",es:"México",hi:"मैक्सिको",it:"Messico",de:"Mexiko"},
KOR:{fr:"Corée du Sud",en:"South Korea",ar:"كوريا الجنوبية",pt:"Coreia do Sul",es:"Corea del Sur",hi:"दक्षिण कोरिया",it:"Corea del Sud",de:"Südkorea"},
RSA:{fr:"Afrique du Sud",en:"South Africa",ar:"جنوب أفريقيا",pt:"África do Sul",es:"Sudáfrica",hi:"दक्षिण अफ़्रीका",it:"Sudafrica",de:"Südafrika"},
DEN:{fr:"Danemark",en:"Denmark",ar:"الدنمارك",pt:"Dinamarca",es:"Dinamarca",hi:"डेनमार्क",it:"Danimarca",de:"Dänemark"},
CAN:{fr:"Canada",en:"Canada",ar:"كندا",pt:"Canadá",es:"Canadá",hi:"कनाडा",it:"Canada",de:"Kanada"},
SUI:{fr:"Suisse",en:"Switzerland",ar:"سويسرا",pt:"Suíça",es:"Suiza",hi:"स्विट्ज़रलैंड",it:"Svizzera",de:"Schweiz"},
QAT:{fr:"Qatar",en:"Qatar",ar:"قطر",pt:"Catar",es:"Catar",hi:"क़तर",it:"Qatar",de:"Katar"},
ITA:{fr:"Italie",en:"Italy",ar:"إيطاليا",pt:"Itália",es:"Italia",hi:"इटली",it:"Italia",de:"Italien"},
BRA:{fr:"Brésil",en:"Brazil",ar:"البرازيل",pt:"Brasil",es:"Brasil",hi:"ब्राज़ील",it:"Brasile",de:"Brasilien"},
MAR:{fr:"Maroc",en:"Morocco",ar:"المغرب",pt:"Marrocos",es:"Marruecos",hi:"मोरक्को",it:"Marocco",de:"Marokko"},
SCO:{fr:"Écosse",en:"Scotland",ar:"اسكتلندا",pt:"Escócia",es:"Escocia",hi:"स्कॉटलैंड",it:"Scozia",de:"Schottland"},
HAI:{fr:"Haïti",en:"Haiti",ar:"هايتي",pt:"Haiti",es:"Haití",hi:"हैती",it:"Haiti",de:"Haiti"},
USA:{fr:"États-Unis",en:"USA",ar:"أمريكا",pt:"EUA",es:"EE.UU.",hi:"अमेरिका",it:"USA",de:"USA"},
AUS:{fr:"Australie",en:"Australia",ar:"أستراليا",pt:"Austrália",es:"Australia",hi:"ऑस्ट्रेलिया",it:"Australia",de:"Australien"},
PAR:{fr:"Paraguay",en:"Paraguay",ar:"باراغواي",pt:"Paraguai",es:"Paraguay",hi:"पैराग्वे",it:"Paraguay",de:"Paraguay"},
TUR:{fr:"Turquie",en:"Türkiye",ar:"تركيا",pt:"Turquia",es:"Turquía",hi:"तुर्की",it:"Turchia",de:"Türkei"},
GER:{fr:"Allemagne",en:"Germany",ar:"ألمانيا",pt:"Alemanha",es:"Alemania",hi:"जर्मनी",it:"Germania",de:"Deutschland"},
CIV:{fr:"Côte d'Ivoire",en:"Ivory Coast",ar:"ساحل العاج",pt:"Costa do Marfim",es:"Costa de Marfil",hi:"आइवरी कोस्ट",it:"Costa d'Avorio",de:"Elfenbeinküste"},
ECU:{fr:"Équateur",en:"Ecuador",ar:"الإكوادور",pt:"Equador",es:"Ecuador",hi:"इक्वाडोर",it:"Ecuador",de:"Ecuador"},
CUR:{fr:"Curaçao",en:"Curaçao",ar:"كوراساو",pt:"Curaçao",es:"Curazao",hi:"कुराकाओ",it:"Curaçao",de:"Curaçao"},
NED:{fr:"Pays-Bas",en:"Netherlands",ar:"هولندا",pt:"Holanda",es:"Países Bajos",hi:"नीदरलैंड",it:"Paesi Bassi",de:"Niederlande"},
TUN:{fr:"Tunisie",en:"Tunisia",ar:"تونس",pt:"Tunísia",es:"Túnez",hi:"ट्यूनीशिया",it:"Tunisia",de:"Tunesien"},
JPN:{fr:"Japon",en:"Japan",ar:"اليابان",pt:"Japão",es:"Japón",hi:"जापान",it:"Giappone",de:"Japan"},
UKR:{fr:"Ukraine",en:"Ukraine",ar:"أوكرانيا",pt:"Ucrânia",es:"Ucrania",hi:"यूक्रेन",it:"Ucraina",de:"Ukraine"},
BEL:{fr:"Belgique",en:"Belgium",ar:"بلجيكا",pt:"Bélgica",es:"Bélgica",hi:"बेल्जियम",it:"Belgio",de:"Belgien"},
IRN:{fr:"Iran",en:"Iran",ar:"إيران",pt:"Irã",es:"Irán",hi:"ईरान",it:"Iran",de:"Iran"},
EGY:{fr:"Égypte",en:"Egypt",ar:"مصر",pt:"Egito",es:"Egipto",hi:"मिस्र",it:"Egitto",de:"Ägypten"},
NZL:{fr:"Nlle-Zélande",en:"New Zealand",ar:"نيوزيلندا",pt:"Nova Zelândia",es:"Nueva Zelanda",hi:"न्यूज़ीलैंड",it:"Nuova Zelanda",de:"Neuseeland"},
ESP:{fr:"Espagne",en:"Spain",ar:"إسبانيا",pt:"Espanha",es:"España",hi:"स्पेन",it:"Spagna",de:"Spanien"},
URU:{fr:"Uruguay",en:"Uruguay",ar:"أوروغواي",pt:"Uruguai",es:"Uruguay",hi:"उरुग्वे",it:"Uruguay",de:"Uruguay"},
KSA:{fr:"Arabie Saoudite",en:"Saudi Arabia",ar:"السعودية",pt:"Arábia Saudita",es:"Arabia Saudí",hi:"सऊदी अरब",it:"Arabia Saudita",de:"Saudi-Arabien"},
CPV:{fr:"Cap-Vert",en:"Cape Verde",ar:"الرأس الأخضر",pt:"Cabo Verde",es:"Cabo Verde",hi:"केप वर्डे",it:"Capo Verde",de:"Kap Verde"},
FRA:{fr:"France",en:"France",ar:"فرنسا",pt:"França",es:"Francia",hi:"फ़्रांस",it:"Francia",de:"Frankreich"},
SEN:{fr:"Sénégal",en:"Senegal",ar:"السنغال",pt:"Senegal",es:"Senegal",hi:"सेनेगल",it:"Senegal",de:"Senegal"},
NOR:{fr:"Norvège",en:"Norway",ar:"النرويج",pt:"Noruega",es:"Noruega",hi:"नॉर्वे",it:"Norvegia",de:"Norwegen"},
IRQ:{fr:"Irak",en:"Iraq",ar:"العراق",pt:"Iraque",es:"Irak",hi:"इराक",it:"Iraq",de:"Irak"},
ARG:{fr:"Argentine",en:"Argentina",ar:"الأرجنتين",pt:"Argentina",es:"Argentina",hi:"अर्जेंटीना",it:"Argentina",de:"Argentinien"},
AUT:{fr:"Autriche",en:"Austria",ar:"النمسا",pt:"Áustria",es:"Austria",hi:"ऑस्ट्रिया",it:"Austria",de:"Österreich"},
JOR:{fr:"Jordanie",en:"Jordan",ar:"الأردن",pt:"Jordânia",es:"Jordania",hi:"जॉर्डन",it:"Giordania",de:"Jordanien"},
ALG:{fr:"Algérie",en:"Algeria",ar:"الجزائر",pt:"Argélia",es:"Argelia",hi:"अल्जीरिया",it:"Algeria",de:"Algerien"},
POR:{fr:"Portugal",en:"Portugal",ar:"البرتغال",pt:"Portugal",es:"Portugal",hi:"पुर्तगाल",it:"Portogallo",de:"Portugal"},
COL:{fr:"Colombie",en:"Colombia",ar:"كولومبيا",pt:"Colômbia",es:"Colombia",hi:"कोलंबिया",it:"Colombia",de:"Kolumbien"},
UZB:{fr:"Ouzbékistan",en:"Uzbekistan",ar:"أوزبكستان",pt:"Uzbequistão",es:"Uzbekistán",hi:"उज़्बेकिस्तान",it:"Uzbekistan",de:"Usbekistan"},
COD:{fr:"RD Congo",en:"DR Congo",ar:"الكونغو",pt:"RD Congo",es:"RD Congo",hi:"कांगो",it:"RD Congo",de:"DR Kongo"},
ENG:{fr:"Angleterre",en:"England",ar:"إنجلترا",pt:"Inglaterra",es:"Inglaterra",hi:"इंग्लैंड",it:"Inghilterra",de:"England"},
CRO:{fr:"Croatie",en:"Croatia",ar:"كرواتيا",pt:"Croácia",es:"Croacia",hi:"क्रोएशिया",it:"Croazia",de:"Kroatien"},
GHA:{fr:"Ghana",en:"Ghana",ar:"غانا",pt:"Gana",es:"Ghana",hi:"घाना",it:"Ghana",de:"Ghana"},
PAN:{fr:"Panama",en:"Panama",ar:"بنما",pt:"Panamá",es:"Panamá",hi:"पनामा",it:"Panama",de:"Panama"},
};
